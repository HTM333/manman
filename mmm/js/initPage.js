...
(function(window,undefined){
	...
	function initPage(id,option){
		...
		if(isPageNum){
			...
			select.style.border='.01rem solid #ddd';
			...
			span1.style.marginRight='.05rem';
			span1.style.verticalAlign='middle';
			span2.innerHTML = '条';
			span2.style.verticalAlign='middle';
			span2.style.marginLeft='.05rem';
			span2.style.marginRight='.15rem';
		...
		if(isJump){
			...
			// input.style.height='.28rem';
			input.style.border='.01rem solid #ddd';
			input.style.padding='0';
			input.style.width='.37rem';
			input.style.textAlign='center';
			input.style.marginRight='.05rem';
			...
			button.style.border='.01rem solid #ddd';
			button.style.verticalAlign='middle';
			// button.style.height='.3rem';
			// button.style.lineHeight='.3rem';
			button.style.backgroundColor='#fafafa';
			button.style.color='#333';
			button.style.outline='none';
			button.style.cursor='pointer';
			jumpDiv.style.display='inline-block';
			jumpDiv.style.marginLeft='.05rem';						
			jumpDiv.id='jumpDiv';
			button.id = 'jump';
			button.innerHTML = '跳转';
	...
	function createPageList(curPage,totalPage,showCount){
		...
		for(i=0;i<lis.length;i++){
			...
			tempLi.childNodes[0].style.padding='.01rem .03rem';
			...
			tempLi.childNodes[0].style.border = '.01rem solid #ddd';
			tempLi.childNodes[0].style.marginLeft = '-.01rem';
